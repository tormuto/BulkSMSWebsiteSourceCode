...
class Alipay {
	...
	*/
	...
	{
		if(empty($params['partner_id'])||empty($params['key']))throw new AlipayException("Supply both parner_id and key");
		return;
		...
		{
			$this->_partner_id = $params['partner_id']; // replace with your production partner ID
			$this->_key = $params['key']; // replace with your production private key
